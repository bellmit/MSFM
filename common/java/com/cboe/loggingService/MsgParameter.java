// Source file: d:/cboe/java/com/cboe/loggingService/MsgParameter.java
...
public class MsgParameter implements Serializable {
    ...
    public MsgParameter(String name, String value) {
        if ( null != name && null != value ) {
            ...
            throw new InvalidMessageParameterException( "Neither name nor value may be null: (" + name + "," + value + ")" );
        }
    }
    ...
    public static MsgParameter[] fromException(Throwable exception) {
        ...
        MsgParameter[] parameters = {
            ...
            new MsgParameter( "exceptionMessage", (null==exceptionMessage)?"No exception message given":exceptionMessage ),
