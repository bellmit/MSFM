...
public class FixedQueueTest extends TestCase
{
    ...
    {
        System.out.println("FixedQueue: testIsEmpty");
        
        
        int capacity = 32;
        Object[] objs = new Object[ capacity ];
        FixedQueue cq = new FixedQueue( capacity );
        ...
        assertEquals( 0, cq.available() );
        assertTrue( cq.isEmpty() );
        assertTrue( cq.isFull() );  // this is a fixed queue, unless cleared, full set of enqueues followed by dequeues leaves it both empty and full
    }

    
    public void testEnqueueDequeue()
    {
        System.out.println("FixedQueue: testEnqueue");
    ...
    {
        System.out.println("FixedQueue: testFlushToArray");
    ...
    public FixedQueueTest(java.lang.String testName)
    {
        super(testName);
    }
    ...
    {
        TestSuite suite = new TestSuite(FixedQueueTest.class);
