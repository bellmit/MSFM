# Snapshot view config spec for CDX Fast-FailoverIteration 3
#
...
# Resolves depdency on /dte_admin/config_specs/cmi/QACMI_RELEASE_ONE_0.13.15.unix.cs
###############################################################################
element * .../cmi_0.13_release_one/QACMI_RELEASE_ONE_0.13.15 -nocheckout
...
element * .../infra_13.0_bomba_CDX_Fast_Failover_POC_Placeholder/LATEST
element * .../infra_13.0_thirteen_two/QAINFRA_THIRTEEN_TWO_13.1.9.1.1 -nocheckout
element * .../infra_13.1_additions/QAINFRA_ADDITIONS_13.1.9.1 -nocheckout
element * .../infra_13.1_crit/QAINFRA_CRIT_13.1.9 -nocheckout
element * /main/QAINFRA_13.1 -nocheckout
...
element * .../sbt_8.2_fast_failover/SBT_FAST_FAILOVER_8.3.59.3.1
end mkbranch sbt_8.2_cdx_ff_shared_dev_iteration_2

mkbranch sbt_8.2_cdx_ff_shared_dev_iteration_2
element * .../sbt_8.0_help_desk_enhancements/CBOEDIR_HELP_DESK_ENHANCEMENTS_8.3.59.3
end mkbranch sbt_8.2_cdx_ff_shared_dev_iteration_2

mkbranch sbt_8.2_cdx_ff_shared_dev_iteration_2
element * .../sbt_8.3_crit/CBOEDIR_CRIT_8.3.59
end mkbranch sbt_8.2_cdx_ff_shared_dev_iteration_2

mkbranch sbt_8.2_cdx_ff_shared_dev_iteration_2
element * /main/CBOEDIR_8.3
