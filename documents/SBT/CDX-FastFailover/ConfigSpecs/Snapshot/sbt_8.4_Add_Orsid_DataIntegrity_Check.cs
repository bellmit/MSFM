# Last updated at 12:26 on 28/Oct/2010 - Modified to point at Add_Orsid_DataIntegrity_branch
...
###############################################################################
# Excerpt from QAIDLBASE_INITIAL_RELEASE_0.1.16.unix.cs - BEGIN
# Resolves dependency on 
# /dte_admin/config_specs/idlbase/QAIDLBASE_INITIAL_RELEASE_0.1.16.unix.cs
###############################################################################
element * .../idlbase_0.1_initial_release/QAIDLBASE_INITIAL_RELEASE_0.1.16 -nocheckout
element * /main/IDLBASE_0.1 -nocheckout
element /idlbase/... /main/0 -nocheckout
################################################################################
# Excerpt from QAIDLBASE_INITIAL_RELEASE_0.1.16.unix.cs - END
################################################################################

###############################################################################
# Excerpt from QACMI_RELEASE_ONE_0.13.15.unix.cs - BEGIN
# Resolves depdency on /dte_admin/config_specs/cmi/QACMI_RELEASE_ONE_0.13.19.unix.cs
###############################################################################
element * .../cmi_0.13_newlinkagebob/LATEST
element * .../cmi_0.13_release_one/QACMI_RELEASE_ONE_0.13.21 -nocheckout
element * /main/QACMI_0.13 -nocheckout
element /cmi/... /main/0 -nocheckout
################################################################################
# Excerpt from QACMI_RELEASE_ONE_0.13.15.unix.cs - END
################################################################################

################################################################################
# EXCERPT FROM QAINFRA_THIRTEEN_TWO_13.1.9.1.1.unix.cs - BEGIN
# Resolves depdency on 
# /dte_admin/config_specs/infra/QAINFRA_THIRTEEN_TWO_13.1.9.1.1.unix.cs
################################################################################
...
# Infra 14
element * .../infra_13.1_fourteen/INFRA_FOURTEEN_13.2.12.1.5 -nocheckout
element * .../infra_13.1_thirteen_four/QAINFRA_THIRTEEN_FOUR_13.2.12.1 -nocheckout
element * .../infra_13.2_crit/QAINFRA_CRIT_13.2.12 -nocheckout
element * /main/QAINFRA_13.2 -nocheckout
...
################################################################################
# EXCERPT FROM QAINFRA_THIRTEEN_TWO_13.1.9.1.1.unix.cs - END
################################################################################
...
#BRANCH
element * .../sbt_8.4_Add_Orsid_DataIntegrity_Check/LATEST

mkbranch sbt_8.4_Add_Orsid_DataIntegrity_Check
element * .../sbt_8.3_eight_six_release/SBT_EIGHT_SIX_RELEASE_8.4.67.2.1
end mkbranch sbt_8.4_Add_Orsid_DataIntegrity_Check

mkbranch sbt_8.4_Add_Orsid_DataIntegrity_Check
element * .../sbt_8.3_eight_five_integ/CBOEDIR_EIGHT_FIVE_INTEG_8.4.67.2
end mkbranch sbt_8.4_Add_Orsid_DataIntegrity_Check

mkbranch sbt_8.4_Add_Orsid_DataIntegrity_Check
element * .../sbt_8.4_crit/CBOEDIR_CRIT_8.4.67
end mkbranch sbt_8.4_Add_Orsid_DataIntegrity_Check

mkbranch sbt_8.4_Add_Orsid_DataIntegrity_Check
element * /main/CBOEDIR_8.4
