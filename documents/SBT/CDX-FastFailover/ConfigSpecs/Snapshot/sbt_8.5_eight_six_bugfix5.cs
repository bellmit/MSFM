# bugfix5 - last updated at 10:00 AM 11/23/2010
...
################################################################################
# EXCERPT FROM QAINFRA_FOURTEEN_13.4.5.1.unix.cs - BEGIN
...
element * INFINISPAN_MOD1_4.2.0.ALPHA2
element * MOCKITO_1.8.2

# Infra 14
element * .../infra_13.1_fourteen/QAINFRA_FOURTEEN_13.4.5.1 -nocheckout
element * .../infra_13.4_crit/QAINFRA_CRIT_13.4.5 -nocheckout
...
################################################################################
# EXCERPT FROM QAINFRA_FOURTEEN_13.4.5.1.unix.cs - END
################################################################################
...
#BRANCH
element * .../sbt_8.5_eight_six_bugfix5/LATEST

mkbranch sbt_8.5_eight_six_bugfix5
element * .../sbt_8.3_eight_six_release/CBOEDIR_EIGHT_SIX_RELEASE_8.5.27.2
end mkbranch sbt_8.5_eight_six_bugfix5

mkbranch sbt_8.5_eight_six_bugfix5
element * .../sbt_8.5_crit/CBOEDIR_CRIT_8.5.27
end mkbranch sbt_8.5_eight_six_bugfix5
...
load \tpt_tools\junit\run_dir
load \tpt_tools\mockito\run_dir
load \cmi\release
