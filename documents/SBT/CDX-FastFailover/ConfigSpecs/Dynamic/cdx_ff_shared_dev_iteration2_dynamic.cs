...
include /vobs/dte/dte_admin/config_specs/build/QABUILD_INIT_COMMON_BUILD_0.0.10.unix.cs
include /vobs/dte/dte_admin/config_specs/idlbase/QAIDLBASE_INITIAL_RELEASE_0.1.13.unix.cs
include /vobs/dte/dte_admin/config_specs/cmi/QACMI_RELEASE_ONE_0.13.11.unix.cs
include /vobs/dte/dte_admin/config_specs/infra/QAINFRA_CRIT_13.1.3.unix.cs
...
#BRANCH
element * .../sbt_8.3_fast_failover_shared_dev_iteration_2/LATEST

mkbranch sbt_8.3_fast_failover_shared_dev_iteration_2
element * .../sbt_8.2_fast_failover_shared_dev/LATEST
end mkbranch sbt_8.3_fast_failover_shared_dev_iteration_2

mkbranch sbt_8.3_fast_failover_shared_dev_iteration_2
element * .../sbt_8.0_help_desk_enhancements/SBT_HELP_DESK_ENHANCEMENTS_8.3.16.8
end mkbranch sbt_8.3_fast_failover_shared_dev_iteration_2

mkbranch sbt_8.3_fast_failover_shared_dev_iteration_2
element * .../sbt_8.3_crit/CBOEDIR_CRIT_8.3.16
end mkbranch sbt_8.3_fast_failover_shared_dev_iteration_2
