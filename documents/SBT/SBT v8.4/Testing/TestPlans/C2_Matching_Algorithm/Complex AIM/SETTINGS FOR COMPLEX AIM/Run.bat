...
if not exist %DRIVE_LETTER%:\ClientSetup\TEST18_TB_Button\APIClient.jar (
echo Cannot find API Client Jar File %DRIVE_LETTER%:\ClientSetup\TEST18_TB_Button\APIClient.jar. Cannot continue.
goto end
)
echo Using API Client Jar: %DRIVE_LETTER%:\ClientSetup\TEST18_TB_Button\APIClient.jar

set CLASSPATH=%DRIVE_LETTER%:\ClientSetup\TEST18_TB_Button\APIClient.jar;%CLASSPATH%
