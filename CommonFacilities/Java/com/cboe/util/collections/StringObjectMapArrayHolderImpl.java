...
/**
 * StringObjectMapArrayHolderImpl.java
 *
 * @author Dmitry Volpyansky
 *
 * FILE GENERATED FROM KeyValueArrayHolderImpl.template (String/String, Object/Object)
 *
 */

public class StringObjectMapArrayHolderImpl implements StringObjectMapArrayHolder
{
    public String[] keys;
    ...
    public static final StringObjectMapArrayHolder EmptyArrayHolder = new StringObjectMapArrayHolderImpl()
    {
        public StringObjectMapArrayHolder add(String key, Object value) {return this;}
    };

    public StringObjectMapArrayHolderImpl()
    {
        this(0);
    }

    public StringObjectMapArrayHolderImpl(int capacity)
    {
