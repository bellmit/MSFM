...
//-----------------------------------------------------------------------------------
//Source file: SessionFirmPostStationKeyBeanInfo
//
//PACKAGE: com.cboe.domain.routingProperty.key
//
...
*/
public class SessionFirmPostStationKeyBeanInfo extends SimpleBeanInfo
{
     ...
     if (allowedDescriptors == null)
     {
         ...
         try
         {
             allowedDescriptors[0] =
                     new PropertyDescriptor(SessionFirmPostStationKey.TRADING_SESSION_PROPERTY_NAME, SessionFirmPostStationKey.class);

             allowedDescriptors[1] =
                     new PropertyDescriptor(SessionFirmPostStationKey.FIRM_PROPERTY_NAME, SessionFirmPostStationKey.class);
