//
// -----------------------------------------------------------------------------------
// Source file: SessionFirmClassCorrBranchKey.java
//
...
public class SessionFirmClassCorrBranchKey extends SessionFirmClassKey  // TODO can this extend SessionFirmClassCorrKey instead ?
{
    ...
    public SessionFirmClassCorrBranchKey(BasePropertyType type)
    {
        super(type);
        this.correspondent = "";
        this.branch = "";
    ...
    public SessionFirmClassCorrBranchKey(String propertyName, String sessionName, String firmAcronym,
    ...
    public SessionFirmClassCorrBranchKey(String propertyKey)
    ...
    {
        SessionFirmClassCorrBranchKey newKey = (SessionFirmClassCorrBranchKey) super.clone();
