//
// -----------------------------------------------------------------------------------
// Source file: SessionClassOriginKey.java
//
...
/**
 * Routing Property Key that uses Session, ProductClass, and OriginCode as key elements
 */
public class SessionClassOriginKey extends SessionClassKey
{
    ...
    public SessionClassOriginKey(BasePropertyType type)
    {
        super(type);
        this.originCode = new OriginCode(' ');
    }

    public SessionClassOriginKey(String propertyName, String sessionName, int classKey, char origin)
    {
        super(propertyName, sessionName, classKey);
        this.originCode = new OriginCode(origin);
    }

    public SessionClassOriginKey(String propertyKey)
    ...
    {
        SessionClassOriginKey newKey = (SessionClassOriginKey) super.clone();
    ...
    {
        String[] forcedEntries = {PRODUCT_CLASS_PROPERTY_NAME, ORIGIN_CODE_PROPERTY_NAME};
