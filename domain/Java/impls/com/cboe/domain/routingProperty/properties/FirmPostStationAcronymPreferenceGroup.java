...
public class FirmPostStationAcronymPreferenceGroup extends AbstractFirmPropertyGroup
{
    public static final BasePropertyType FIRM_PROPERTY_TYPE = FirmPropertyTypeImpl.MMTN_MAPPING_POST_STATION;

    private static final String MMTN_MAPPING_PREFERENCE = "FirmMMTNPostStationMapping";

    private AcronymProperty mmtnMappingPreference;

    public FirmPostStationAcronymPreferenceGroup(BasePropertyKey basePropertyKey)
    {
    ...
    public FirmPostStationAcronymPreferenceGroup(BasePropertyKey basePropertyKey, int versionNumber)
    {
        super(basePropertyKey, versionNumber);
    }

    public FirmPostStationAcronymPreferenceGroup(BasePropertyKey basePropertyKey, List<Validator> validators)
    {
    ...
    public FirmPostStationAcronymPreferenceGroup(BasePropertyKey basePropertyKey, int versionNumber, List<Validator> validators)
    {
