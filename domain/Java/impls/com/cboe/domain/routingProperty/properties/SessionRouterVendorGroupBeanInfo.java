...
public class SessionRouterVendorGroupBeanInfo extends AbstractRoutingPropertyGroupBeanInfo
{
        ...
        if (allowedDescriptors == null)
        {
            ...
            try
            {
                allowedDescriptors[0] =
                        new PropertyDescriptor(SessionRouterVendorKey.ROUTER_VENDOR_PROPERTY_NAME, SessionRouterVendorKey.class);
            }
