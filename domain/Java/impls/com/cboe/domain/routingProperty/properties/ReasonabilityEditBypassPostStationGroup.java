...
public class ReasonabilityEditBypassPostStationGroup extends AbstractRoutingPropertyGroup
{
    public static final String ORIGIN_TYPES = "Origins";
    public static BasePropertyType ROUTING_PROPERTY_TYPE = RoutingPropertyTypeImpl.REASONABILITY_EDIT_BYPASS_POST_STATION;
    private StringBasePropertyImpl originTypes;

    public ReasonabilityEditBypassPostStationGroup(BasePropertyKey basePropertyKey)
    {
        super(basePropertyKey);
    }

    public ReasonabilityEditBypassPostStationGroup(BasePropertyKey basePropertyKey, PropertyServicePropertyGroup propertyGroup)
            throws DataValidationException, InvocationTargetException
    {
        super(basePropertyKey, propertyGroup);
    }

    public ReasonabilityEditBypassPostStationGroup(BasePropertyKey basePropertyKey, int versionNumber)
    {
        super(basePropertyKey, versionNumber);
    }

    public ReasonabilityEditBypassPostStationGroup(BasePropertyKey basePropertyKey, List<Validator> validators)
    {
    ...
    {
        return RoutingPropertyTypeImpl.REASONABILITY_EDIT_BYPASS_POST_STATION;
    }
