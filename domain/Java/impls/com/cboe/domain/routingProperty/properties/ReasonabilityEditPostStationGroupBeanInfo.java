...
public class ReasonabilityEditPostStationGroupBeanInfo extends AbstractRoutingPropertyGroupBeanInfo
{
        ...
        if (allowedDescriptors == null)
        {
            ...
            try
            {
                allowedDescriptors[0] =
                        new PropertyDescriptor(SessionFirmPostStationKey.POST_PROPERTY_NAME,
                                               SessionFirmPostStationKey.class);

                allowedDescriptors[1] =
                        new PropertyDescriptor(SessionFirmPostStationKey.STATION_PROPERTY_NAME,
                                               SessionFirmPostStationKey.class);
            }
