...
// -----------------------------------------------------------------------------------
// Source file: LongBasePropertyImplBeanInfo
//
// PACKAGE: com.cboe.domain.routingProperty.common
// 
 ...
 */
public class LongBasePropertyImplBeanInfo extends SimpleBeanInfo
{
        ...
        if (allowedDescriptors == null)
        {
            ...
            try
            {
                allowedDescriptors[0] =
                        new PropertyDescriptor("longValue", LongBasePropertyImpl.class);
            }
