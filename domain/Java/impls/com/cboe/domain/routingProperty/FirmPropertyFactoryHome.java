...
// -----------------------------------------------------------------------------------
// Source file: FirmPropertyFactoryHome
//
// PACKAGE: com.cboe.domain.routingProperty
// 
// Created: 
...
public class FirmPropertyFactoryHome
{
    private static BasePropertyFactory factory;

    private FirmPropertyFactoryHome() {}
    ...
    public static void create(Class theClass, Object[] constructorParms)
    {
        try
        {
            ...
            {
                throw new IllegalArgumentException("FirmPropertyFactoryHome: Does not support interface " +
    ...
    public static com.cboe.interfaces.domain.routingProperty.BasePropertyFactory find()
    {
        ...
        {
            create("com.cboe.domain.routingProperty.FirmPropertyFactoryImpl",null);
            return factory;
