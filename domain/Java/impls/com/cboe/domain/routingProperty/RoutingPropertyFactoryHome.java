...
// -----------------------------------------------------------------------------------
// Source file: RoutingPropertyFactoryHome
//
// PACKAGE: com.cboe.domain.routingProperty
// 
// Created: Jun 20, 2006 2:32:23 PM
// -----------------------------------------------------------------------------------
...
public class RoutingPropertyFactoryHome
{
    private static BasePropertyFactory factory;

    private RoutingPropertyFactoryHome() {}
    ...
    public static void create(Class theClass, Object[] constructorParms)
    {
        try
        {
            ...
            {
                throw new IllegalArgumentException("RoutingPropertyFactoryHome: Does not support interface " +
    ...
    public static com.cboe.interfaces.domain.routingProperty.BasePropertyFactory find()
    {
        ...
        {
            throw new IllegalStateException("RoutingPropertyFactoryHome: Create has not been called yet.");
        }
    }
}
