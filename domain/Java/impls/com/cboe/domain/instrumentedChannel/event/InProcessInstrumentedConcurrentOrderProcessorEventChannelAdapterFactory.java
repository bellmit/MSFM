...
public class InProcessInstrumentedConcurrentOrderProcessorEventChannelAdapterFactory
{
    private static class IECAdapterHolder
    {
        private static InstrumentedEventChannelAdapter eventChannel = new InProcessInstrumentedConcurrentOrderEventChannelAdapter();
    }
