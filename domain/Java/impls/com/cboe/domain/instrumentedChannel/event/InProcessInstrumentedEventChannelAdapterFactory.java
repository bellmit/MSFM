...
public class InProcessInstrumentedEventChannelAdapterFactory
{
    private static class IECAdapterHolder
    {
        private static InstrumentedEventChannelAdapter eventChannel = new InProcessInstrumentedEventChannelAdapter();
    }   
