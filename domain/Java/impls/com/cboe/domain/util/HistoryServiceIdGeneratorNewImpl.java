...
public class HistoryServiceIdGeneratorNewImpl implements HistoryServiceIdGenerator
{
	private IdService idService;
	
	public HistoryServiceIdGeneratorNewImpl()
	{
		getIdService();
	}
	...
	public Object getId()
	{
		...
		try
		{
			rval = new Long(getIdService().getNextUUIDFromBlock());
		}
		catch (Exception e)
		{
