...
/**
 * Natively int-keyed ConcurrentHashMap implementation.  Source is ripped from JDK 1.6_07 
 * ConcurrentHashMap, merged to a single class, any minimally mutated to replace all K 
 * references with int.
 * 
 * @author Steve
 * 
 * @see com.cboe.domain.util.intMaps.IntHashMap
 * @see java.util.AbstractHashMap.SimpleEntry
 * @see java.util.HashMap
 *
 * @param <V> Type of value to store in map
 */
public final class ConcurrentIntHashMap<V> implements IntMap<V>
{
    /*
    ...
    transient Set<IntMapEntry<V>>   entrySet;
     ...
     * ConcurrentIntHashMap uses power-of-two length hash tables, that otherwise
    ...
    /**
     * ConcurrentIntHashMap list entry. Note that this is never exported out as
     * a user-visible Map.Entry.
     * 
     ...
     */
    static final class Segment<V> extends ReentrantLock
    {
        /*
    ...
    {
        for (IntMapEntry<? extends V> e : m.entrySet())
    ...
    final class KeyIterator extends HashIterator implements Iterator<Integer>, Enumeration<Integer>
    {
        public Integer next()
        {
            return new Integer(super.nextEntry().key);
        }
     ...
     */
    final class WriteThroughEntry implements IntMapEntry<V>
    {
        // ///////////////////////
        ...
        public V setValue(V value)
        {
            ...
            V v = this.value;
            this.value = value;
            ConcurrentIntHashMap.this.put(getKey(), value);
            return v;
        }
    }

    final class EntryIterator extends HashIterator implements Iterator<IntMapEntry<V>>
    {
    ...
    final class KeySet extends AbstractSet<Integer>
    {
        ...
        public int size()
        {
            return ConcurrentIntHashMap.this.size();
        }
        
        public boolean contains(Object o)
        {
            return o instanceof Integer 
                && ConcurrentIntHashMap.this.containsKey(((Integer)o).intValue());
        }

        public boolean remove(Object o)
        {
            return o instanceof Integer 
                && ConcurrentIntHashMap.this.remove(((Integer)o).intValue()) != null;
        }

        public void clear()
        {
            ConcurrentIntHashMap.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V>
    {
        ...
        public boolean contains(Object o)
        {
            return ConcurrentIntHashMap.this.containsValue(o);
        }
    ...
    final class EntrySet extends AbstractSet<IntMapEntry<V>>
    {
        ...
        public boolean contains(Object o)
        {
            if (!(o instanceof IntMapEntry))
                return false;
            IntMapEntry<?> e = (IntMapEntry<?>) o;
            V v = ConcurrentIntHashMap.this.get(e.getKey());
        ...
        public boolean remove(Object o)
        {
            if (!(o instanceof IntMapEntry))
                return false;
            IntMapEntry<?> e = (IntMapEntry<?>) o;
            return ConcurrentIntHashMap.this.remove(e.getKey(), e.getValue());
        }
    ...
    public String toString()
    {
        StringBuffer buf = new StringBuffer(Math.max(1024, size()*16));
        Set<IntMapEntry<V>> data = entrySet();
        buf.append('{');
        int idx=0;
        int size=data.size();
        for (IntMapEntry<V> datum : data)
        {
            buf.append(datum.getKey()).append('=').append(datum.getValue());
            if (++idx < size)
            {
                buf.append(", ");
            }
