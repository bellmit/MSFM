 ...
 */
public class ExtremelyWideQuoteWidthGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.EXTREMELY_WIDE_QUOTE_WIDTH;
     ...
     */
    public ExtremelyWideQuoteWidthGroup(String sessionName, int classKey)
    {
     ...
     */
    public ExtremelyWideQuoteWidthGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static ExtremelyWideQuoteWidthGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (ExtremelyWideQuoteWidthGroup)newGroup;
    }

    public TradingProperty createNewTradingProperty(String sessionName, int classKey)
    {
        return new ExtremelyWideQuoteWidthImpl(getTradingPropertyType(), sessionName, classKey);
    }

    /**
     * Gets all the contained ExtremelyWideQuoteWidth Trading Properties.
     */
    public ExtremelyWideQuoteWidth[] getExtremelyWideQuoteWidthTradingProperties()
    {
        TradingProperty[] allTPs = getAllTradingProperties();
        ExtremelyWideQuoteWidth[] castedTPs = new ExtremelyWideQuoteWidth[allTPs.length];
