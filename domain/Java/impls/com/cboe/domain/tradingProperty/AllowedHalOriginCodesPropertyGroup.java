...
/**
 * Represents a TradingPropertyGroup for the New Hal Origin Codes.
 */
public class AllowedHalOriginCodesPropertyGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.ALLOWED_HAL_ORIGIN_CODES;
     ...
     */
    public AllowedHalOriginCodesPropertyGroup(String sessionName, int classKey)
    {
     ...
     */
    public AllowedHalOriginCodesPropertyGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static AllowedHalOriginCodesPropertyGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (AllowedHalOriginCodesPropertyGroup)newGroup;
    }

    public TradingProperty createNewTradingProperty(String sessionName, int classKey)
    {
        return new AllowedHalOriginCodesImpl(getTradingPropertyType(), sessionName, classKey);
    }

    /**
     * Gets all the contained ExtremelyWideQuoteWidth Trading Properties.
     */
    public AllowedHalOriginCodes[] getAllowedHalOriginCodesTradingProperties()
    {
        TradingProperty[] allTPs = getAllTradingProperties();
        AllowedHalOriginCodes[] castedTPs = new AllowedHalOriginCodes[allTPs.length];
