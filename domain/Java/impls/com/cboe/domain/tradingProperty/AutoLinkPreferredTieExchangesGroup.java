//
// -----------------------------------------------------------------------------------
// Source file: ExtremelyWideQuoteWidthGroup.java
//
...
/**
 * Represents a TradingPropertyGroup for the Opening Extremely Wide Quote Width.
 */
public class AutoLinkPreferredTieExchangesGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.AUTO_LINK_PREFERRED_TIE_EXCHANGES;
     ...
     */
    public AutoLinkPreferredTieExchangesGroup(String sessionName, int classKey)
    {
     ...
     */
    public AutoLinkPreferredTieExchangesGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static AutoLinkPreferredTieExchangesGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (AutoLinkPreferredTieExchangesGroup)newGroup;
    }

    public TradingProperty createNewTradingProperty(String sessionName, int classKey)
    {
        return new AutoLinkPreferredTieExchangesImpl(getTradingPropertyType(), sessionName, classKey);
    }

    /**
     * Gets all the contained ExtremelyWideQuoteWidth Trading Properties.
     */
    public AutoLinkPreferredTieExchanges[] getAutoLinkPreferredTieExchangesTradingProperties()
    {
        TradingProperty[] allTPs = getAllTradingProperties();
        AutoLinkPreferredTieExchanges[] castedTPs = new AutoLinkPreferredTieExchanges[allTPs.length];
