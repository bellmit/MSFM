//
// -----------------------------------------------------------------------------------
// Source file: SimpleIntegerTradingPropertyGroup.java
//
...
/**
 * Represents a TradingPropertyGroup for a single simple integer
 */
public class SimpleIntegerTradingPropertyGroup extends AbstractTradingPropertyGroup
{
     ...
     */
    public SimpleIntegerTradingPropertyGroup(String sessionName, int classKey)
    {
     ...
     */
    public SimpleIntegerTradingPropertyGroup(String sessionName, int classKey, PropertyServicePropertyGroup propertyGroup)
     ...
     */
    public static SimpleIntegerTradingPropertyGroup getGroup(String sessionName, int classKey,
    ...
    {
        SimpleIntegerTradingPropertyGroup myGroup =
                (SimpleIntegerTradingPropertyGroup) TradingPropertyFactoryHome.find().getTradingPropertyGroup(sessionName,
                                                                                                   classKey,
     ...
     */
    public static SimpleIntegerTradingPropertyGroup getGroupWithDefault(String sessionName, int classKey, TradingPropertyType tradingPropertyType)
            throws SystemException, NotFoundException, DataValidationException, CommunicationException,
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        SimpleIntegerTradingPropertyGroup myGroup = null;
