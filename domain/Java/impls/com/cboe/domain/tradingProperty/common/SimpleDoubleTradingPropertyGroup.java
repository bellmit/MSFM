//
// -----------------------------------------------------------------------------------
// Source file: SimpleDoubleTradingPropertyGroup.java
//
...
/**
 * Represents a TradingPropertyGroup for a single simple double
 */
public class SimpleDoubleTradingPropertyGroup extends AbstractTradingPropertyGroup
{
     ...
     */
    public SimpleDoubleTradingPropertyGroup(String sessionName, int classKey)
    {
     ...
     */
    public SimpleDoubleTradingPropertyGroup(String sessionName, int classKey, PropertyServicePropertyGroup propertyGroup)
     ...
     */
    public static SimpleDoubleTradingPropertyGroup getGroup(String sessionName, int classKey,
    ...
    {
        SimpleDoubleTradingPropertyGroup myGroup =
                (SimpleDoubleTradingPropertyGroup) TradingPropertyFactoryHome.find().getTradingPropertyGroup(sessionName,
                                                                                                  classKey,
     ...
     */
    public static SimpleDoubleTradingPropertyGroup getGroupWithDefault(String sessionName, int classKey, TradingPropertyType tradingPropertyType)
            throws SystemException, NotFoundException, DataValidationException, CommunicationException,
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        SimpleDoubleTradingPropertyGroup  myGroup = null;
    ...
    {
        SimpleDoubleTradingPropertyImpl newTP =
                new SimpleDoubleTradingPropertyImpl(getTradingPropertyType().getFullName(), sessionName, classKey);
     ...
     */
    public SimpleDoubleTradingProperty getDoubleTradingProperty()
    {
        TradingProperty[] tradingProperties = getAllTradingProperties();
        if(tradingProperties.length > 0)
        {
            return (SimpleDoubleTradingProperty) tradingProperties[0];
        }
        else
        {
            return null;
