 ...
 */
public class TicksAwayForReCOAGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.TICKS_AWAY_FOR_RECOA;
     ...
     */
    public TicksAwayForReCOAGroup(String sessionName, int classKey)
    {
     ...
     */
    public TicksAwayForReCOAGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static TicksAwayForReCOAGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (TicksAwayForReCOAGroup)newGroup;
    }
     ...
     */ 
    public ExchangePrescribedWidth[] getTicksAwayForReCOAGroupTradingProperties()
    {
