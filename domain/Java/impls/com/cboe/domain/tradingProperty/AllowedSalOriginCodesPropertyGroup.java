...
public class AllowedSalOriginCodesPropertyGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE = 
        TradingPropertyTypeImpl.ALLOWED_SAL_ORIGIN_CODES;
     ...
     */
    public AllowedSalOriginCodesPropertyGroup(String sessionName, int classKey)
    {
     ...
     */
    public AllowedSalOriginCodesPropertyGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static AllowedSalOriginCodesPropertyGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (AllowedSalOriginCodesPropertyGroup)newGroup;
    }
    
    public TradingProperty createNewTradingProperty(String sessionName, int classKey)
    {
        return new AllowedSalOriginCodesImpl(getTradingPropertyType(), sessionName, classKey);
    }
    
    /**
     * Gets all the contained ExtremelyWideQuoteWidth Trading Properties.
     */
    public AllowedSalOriginCodes[] getAllowedSalOriginCodesTradingProperties()
    {
        TradingProperty[] allTPs = getAllTradingProperties();
        AllowedSalOriginCodes[] castedTPs = new AllowedSalOriginCodes[allTPs.length];
