...
public class RolloutFlagByBCGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.ROLLOUT_FLAG_BY_BC;
     ...
     */
    public RolloutFlagByBCGroup(String sessionName, int classKey)
    {
     ...
     */
    public RolloutFlagByBCGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static RolloutFlagByBCGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (RolloutFlagByBCGroup)newGroup;
    }

    public TradingProperty createNewTradingProperty(String sessionName, int classKey)
    {
        return new RolloutFlagByBCImpl(getTradingPropertyType(), sessionName, classKey);
    }

    /**
     * Gets all the contained AutoLinkDisqualifiedExchanges Trading Properties.
     */
    public RolloutFlagByBC[] getRolloutBCTradingProperties()
    {
        TradingProperty[] allTPs = getAllTradingProperties();
        RolloutFlagByBC[] castedTPs = new RolloutFlagByBC[allTPs.length];
