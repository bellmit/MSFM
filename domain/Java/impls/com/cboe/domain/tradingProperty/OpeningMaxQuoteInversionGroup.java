 ...
 */
public class OpeningMaxQuoteInversionGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.OPENING_MAX_QUOTE_INVERSION;
     ...
     */
    public OpeningMaxQuoteInversionGroup(String sessionName, int classKey)
    {
     ...
     */
    public OpeningMaxQuoteInversionGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static OpeningMaxQuoteInversionGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (OpeningMaxQuoteInversionGroup)newGroup;
    }
     ...
     */ 
    public ExchangePrescribedWidth[] getOpeningMaxQuoteInversionTradingProperties()
    {
