...
/**
 * Represents a TradingPropertyGroup for the Auto Link Origin Codes.
 * 
 * @author misbahud
 *
 */
public class AutoLinkOriginCodesGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.AUTO_LINK_ORIGIN_CODES;
     ...
     */
    public AutoLinkOriginCodesGroup(String sessionName, int classKey)
    {
     ...
     */
    public AutoLinkOriginCodesGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static AutoLinkOriginCodesGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (AutoLinkOriginCodesGroup)newGroup;
    }

    public TradingProperty createNewTradingProperty(String sessionName, int classKey)
    {
        return new AutoLinkOriginCodesImpl(getTradingPropertyType(), sessionName, classKey);
    }

    /**
     * Gets all the contained AutoLinkOriginCodes Trading Properties.
     */
    public AutoLinkOriginCodes[] getAutoLinkOriginCodesTradingProperties()
    {
        TradingProperty[] allTPs = getAllTradingProperties();
        AutoLinkOriginCodes[] castedTPs = new AutoLinkOriginCodes[allTPs.length];
