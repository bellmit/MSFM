//
// -----------------------------------------------------------------------------------
// Source file: LeapsOpeningEPWGroup.java
//
...
public class LeapsOpeningEPWGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.LEAPS_OEPW;
     ...
     */
    public LeapsOpeningEPWGroup(String sessionName, int classKey)
    {
     ...
     */
    public LeapsOpeningEPWGroup(String sessionName, int classKey, PropertyServicePropertyGroup propertyGroup)
     ...
     */
    public LeapsOpeningEPWGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static LeapsOpeningEPWGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (LeapsOpeningEPWGroup) newGroup;
    }
