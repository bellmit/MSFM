 ...
 */
public class OpeningExchangePrescribedWidthGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.OPENING_EXCHANGE_PRESCRIBED_WIDTH;
     ...
     */
    public OpeningExchangePrescribedWidthGroup(String sessionName, int classKey)
    {
     ...
     */
    public OpeningExchangePrescribedWidthGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static OpeningExchangePrescribedWidthGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (OpeningExchangePrescribedWidthGroup)newGroup;
    }
