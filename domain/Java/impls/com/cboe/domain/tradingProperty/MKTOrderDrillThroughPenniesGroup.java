...
/**
 * Represents a TradingPropertyGroup for the MKT Drill Through Pennies.
 *
 * @author montiel
 *
 */
public class MKTOrderDrillThroughPenniesGroup extends AbstractTradingPropertyGroup
{
    public static final TradingPropertyType TRADING_PROPERTY_TYPE =
            TradingPropertyTypeImpl.MKT_ORDER_DRILL_THROUGH_PENNIES;
     ...
     */
    public MKTOrderDrillThroughPenniesGroup(String sessionName, int classKey)
    {
     ...
     */
    public MKTOrderDrillThroughPenniesGroup(String sessionName, int classKey, int versionNumber)
    {
     ...
     */
    public static MKTOrderDrillThroughPenniesGroup getGroup(String sessionName, int classKey)
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        return (MKTOrderDrillThroughPenniesGroup)newGroup;
    }

    public TradingProperty createNewTradingProperty(String sessionName, int classKey)
    {
        return new MKTOrderDrillThroughPenniesImpl (getTradingPropertyType(), sessionName, classKey);
    }

    /**
     * Gets all the contained MKTOrderDrillThroughPennies Trading Properties.
     */
    public MKTOrderDrillThroughPennies[] getMKTOrderDrillThroughPenniesTradingProperties()
    {
        TradingProperty[] allTPs = getAllTradingProperties();
        MKTOrderDrillThroughPennies[] castedTPs = new MKTOrderDrillThroughPennies[allTPs.length];
