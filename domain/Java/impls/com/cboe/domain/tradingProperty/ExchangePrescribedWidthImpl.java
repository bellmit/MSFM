 ...
 */
public class ExchangePrescribedWidthImpl extends AbstractTradingProperty
        implements ExchangePrescribedWidth
{
     ...
     */
    public ExchangePrescribedWidthImpl(TradingPropertyType tradingPropertyType,
     ...
     */
    public ExchangePrescribedWidthImpl(TradingPropertyType tradingPropertyType, String sessionName, int classKey,
                                       Property property)
    ...
    public void setMinimumBidRange(double minBid)
    {
        if(Log.isDebugOn())
        {
            Log.debug("ExchangePrescribedWidthImpl>> Saving minimumBidRange value = " + minBid);
        }
    ...
    public void setMaximumBidRange(double maxBid)
    {
        if(Log.isDebugOn())
        {
            Log.debug("ExchangePrescribedWidthImpl>> Saving maximumBidRange value = " + maxBid);
        }
    ...
    public void setMaximumAllowableSpread(double maxSpread)
    {
        if(Log.isDebugOn())
        {
            Log.debug("ExchangePrescribedWidthImpl>> Saving maximumAllowableSpread value = " + maxSpread);
        }
