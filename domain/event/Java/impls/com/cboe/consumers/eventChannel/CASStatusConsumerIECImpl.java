...
public class CASStatusConsumerIECImpl extends BObject implements ComponentConsumer
{
     ...
     * constructor comment.
     */
    public CASStatusConsumerIECImpl() {
        super();
 ...
 */
    public void acceptComponentIsMaster(String componentName, boolean isMaster)
    {
        if(isMaster)
        {
            ...
            channelKey = new ChannelKey(ChannelKey.CB_CAS_UP, INT_0);
    ...
    public void allRegisteredComponentsFailed()
    {
        ...
        channelKey = new ChannelKey(ChannelKey.CB_CAS_DOWN, INT_0);
