...
import com.cboe.consumers.eventChannel.EventChannelFilterHelper;
     ...
     * @author Jeff Illian
     */
public class CASAdminConsumerHomePublisherImpl extends BOHome implements IECCASAdminConsumerHome
{
     ...
     */
    public CASAdminConsumerHomePublisherImpl()
    {
        super();
    }
    ...
    public void start()
    {
        try
        {
            ...
            String repID = CASAdminEventConsumerHelper.id();
            obj = eventService.getEventChannelSupplierStub( eventChannelName, repID );
            casAdminEvent = CASAdminEventConsumerHelper.narrow( obj );

            casAdminConsumer = new CASAdminConsumerPublisherImpl(casAdminEvent);
