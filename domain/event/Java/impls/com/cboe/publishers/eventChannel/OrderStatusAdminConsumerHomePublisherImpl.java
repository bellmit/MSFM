 ...
 * @author Emily Huang
 */
public class OrderStatusAdminConsumerHomePublisherImpl extends BOHome
     implements OrderStatusAdminConsumerHome
{
  ...
  public void start()
  {
      try
      {
          String interfaceRepId = OrderStatusAdminEventConsumerHelper.id();

          String eventChannelName = eventChannelFilterHelper.getChannelName(CHANNEL_NAME);
          String repID = OrderStatusAdminEventConsumerHelper.id();
          org.omg.CORBA.Object obj = eventService.getEventChannelSupplierStub( eventChannelName, repID );
          orderStatatusAdminEvent = OrderStatusAdminEventConsumerHelper.narrow( obj );

          orderStatusAdminConsumer = new OrderStatusAdminConsumerPublisherImpl(orderStatatusAdminEvent);
