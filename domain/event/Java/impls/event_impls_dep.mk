...
# 
#######################################################################
EVENT_IMPLS_CLASSPATH=$(EVENT_IMPLS_CLASS):$(CMI_IDL_JAR):$(EVENT_INTERFACES_BUILD_JAR):$(DOMAIN_INTERFACES_BUILD_JAR):$(DOMAIN_IMPLS_BUILD_JAR):$(DOMAIN_IDL_BUILD_JAR):$(EVENT_IDL_BUILD_JAR):$(SERVER_INTERFACES_BUILD_JAR):$(CLIENT_INTERFACES_BUILD_JAR):$(ICS_IDL_BUILD_JAR):$(COMMONFACILITIES_BUILD_JAR):$(FFJAR):$(OBJWAVEJAR):$(LGJAR):$(LGINTJAR):$(CMJAR):$(OMGBASECLASSESJAR):$(OMGSERVICECLASSESJAR):$(JUNITJAR):$(JUNITJAR2):$(IVIDLCLASSESJAR):$(SMJAR):$(JAWJAR):$(MSG_CODEC):$(MSIMPJAR)
...
# 
#######################################################################
EVENT_IMPLS_DEPENDS=$(filter %.jar,$(subst :, ,$(EVENT_IMPLS_CLASSPATH)))
