 ...
 * @author Jeff Illian
 */
public interface RecapConsumerHome {
	/**
	 * Name that will be used for this home.
	 */
	public final static String HOME_NAME = "RecapConsumerHome";
	public final static String INTERNAL_HOME_NAME = "InternalRecapConsumerHome";
  /**
   * Returns a reference to the RecapConsumer service.
   *
   * @return reference to RecapConsumer service
   *
   * @author Jeff Illian
   */
  public RecapConsumer find();
  /**
   * Creates an instance of the RecapConsumer service.
   *
   * @return reference to RecapConsumer service
   *
   * @author Jeff Illian
