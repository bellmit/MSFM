 ...
 * The interface for MDX Market Data.
 */

import com.cboe.exceptions.*;

public interface CfixMDXMarketDataDispatcherIF {
    ...
    public void   subscribeByProduct(CfixMDXMarketDataConsumerHolder   cfixFixMDXMarketDataConsumerHolder, boolean isUserSub) throws SystemException, CommunicationException, AuthorizationException, DataValidationException, NotFoundException;
    public void   unsubscribeByProduct(CfixMDXMarketDataConsumerHolder cfixFixMDXMarketDataConsumerHolder, boolean isUserSub) throws SystemException, CommunicationException, AuthorizationException, DataValidationException, NotFoundException;
    public void   subscribeByClass(CfixMDXMarketDataConsumerHolder     cfixFixMDXMarketDataConsumerHolder, boolean isUserSub) throws SystemException, CommunicationException, AuthorizationException, DataValidationException, NotFoundException;
    public void   unsubscribeByClass(CfixMDXMarketDataConsumerHolder   cfixFixMDXMarketDataConsumerHolder, boolean isUserSub) throws SystemException, CommunicationException, AuthorizationException, DataValidationException, NotFoundException;
    ...
    public void   accept(CfixMDXMarketDataDispatcherVisitor            cfixMarketDataDispatcherVisitor) throws SystemException, CommunicationException, AuthorizationException, DataValidationException, NotFoundException;
