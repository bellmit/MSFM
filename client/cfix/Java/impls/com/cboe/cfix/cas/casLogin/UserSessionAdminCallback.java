...
public class UserSessionAdminCallback extends com.cboe.idl.cmiCallback.CMIUserSessionAdminPOA {
  ...
  public UserSessionAdminCallback() {
    super();
   }
  /**
...
//      }
   ...
   */
   public void acceptLogout (String reason ) {
      if (getVerbose()&&Log.isDebugOn()){
          Log.debug("Logged out of the CAS for the following reason: "+reason);
      }
   }
  /**
   * Part of the CMIUserSessionAdmin interface. This implementation
  ...
  public void acceptCallbackRemoval(
    com.cboe.idl.cmiUtil.CallbackInformationStruct callbackInfo,
   ...
   */
   ...
   public void setCfixCasLogin(CfixCasLogin aCfixCasLogin){
      this.theCfixCasLogin = aCfixCasLogin;
   }
  /**
   * This setter is not part of the CMIUserSessionAdmin interface.
   ...
   */
   public boolean getVerbose(){
    ...
    private void switchCAS(){
        theCfixCasLogin.switchCAS();
    }
