...
/**
 * CfixMarketDataBookDepthDispatcherImpl.java
 *
...
public final class CfixMarketDataBookDepthDispatcherImpl extends CfixMarketDataDispatcherImpl
{
    public static final String MARKET_DATA_TYPE_NAME = "BookDepth";

    public CfixMarketDataBookDepthDispatcherImpl(String name)
    {
        super(name);
    }
