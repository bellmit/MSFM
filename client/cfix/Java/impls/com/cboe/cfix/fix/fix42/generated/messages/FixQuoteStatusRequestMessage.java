...
/**
 * FixQuoteStatusRequestMessage.java
 *
...
/**
 * This GENERATED file implements FIX Protocol's QuoteStatusRequest Message.
 *
...
public class FixQuoteStatusRequestMessage extends FixMessage
{   
    public static final String MsgType        = "a";
    public static final char   MsgTypeAsChar  = 'a';
    public static final char[] MsgTypeAsChars = {'a'};
    public static final String MsgTypeName    = "QuoteStatusRequest";
    ...
    public FixCboeQuoteStatusRequestTypeField    fieldCboeQuoteStatusRequestType;
    public List                                  additionalUserFields;

    public FixQuoteStatusRequestMessage()
    {

    }

    public boolean isFixQuoteStatusRequestMessage() {return true;}
    ...
    public void accept(PrettyPrintWriterIF prettyPrintWriter)
    {
        ...
        prettyPrintWriter.printGroupItem(fieldCboeQuoteStatusRequestType);
    ...
    public void accept(FixMessageBuilderIF fixMessageBuilder)
    {
        ...
        fixMessageBuilder.append(fieldCboeQuoteStatusRequestType);
    ...
    public PackedIntArrayIF build(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        for (currentPosition = 0; currentPosition < numTags; currentPosition++)
        {
            ...
            switch (tag)
            {
                ...
                case FixCboeQuoteStatusRequestTypeField.TagID:
                {
                    if (currentState != STATE_Field)
                    {
                        currentState = STATE_Field;
                    ...
                    if (fieldCboeQuoteStatusRequestType != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    fieldCboeQuoteStatusRequestType = FixCboeQuoteStatusRequestTypeField.create(array, offset, length);
                    if (fieldCboeQuoteStatusRequestType == null || !fieldCboeQuoteStatusRequestType.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
