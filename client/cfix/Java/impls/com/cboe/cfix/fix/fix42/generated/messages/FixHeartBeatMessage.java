...
/**
 * This GENERATED file implements FIX Protocol's HeartBeat Message.
 *
...
public class FixHeartBeatMessage extends FixMessage
{   
    public static final String MsgType        = "0";
    public static final char   MsgTypeAsChar  = '0';
    public static final char[] MsgTypeAsChars = {'0'};
    public static final String MsgTypeName    = "HeartBeat";

    public FixTestReqIDField    fieldTestReqID;
    public List                 additionalUserFields;

    public FixHeartBeatMessage()
    {

    }

    public boolean isFixHeartBeatMessage() {return true;}
