...
/**
 * This GENERATED file implements FIX Protocol's SequenceReset Message.
 *
...
public class FixSequenceResetMessage extends FixMessage
{   
    public static final String MsgType        = "4";
    public static final char   MsgTypeAsChar  = '4';
    public static final char[] MsgTypeAsChars = {'4'};
    public static final String MsgTypeName    = "SequenceReset";

    public FixGapFillFlagField    fieldGapFillFlag;
    public FixNewSeqNoField       fieldNewSeqNo;
    public List                   additionalUserFields;

    public FixSequenceResetMessage()
    {

    }

    public boolean isFixSequenceResetMessage() {return true;}
    ...
    public void accept(PrettyPrintWriterIF prettyPrintWriter)
    {
        ...
        prettyPrintWriter.printGroupItem(fieldGapFillFlag);
        prettyPrintWriter.printGroupItem(fieldNewSeqNo);
    ...
    public void accept(FixMessageBuilderIF fixMessageBuilder)
    {
        ...
        fixMessageBuilder.append(fieldGapFillFlag);
        fixMessageBuilder.append(fieldNewSeqNo);
    ...
    public PackedIntArrayIF validate(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        if (fieldNewSeqNo == null)
        {
            foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixNewSeqNoField.TagID));
            if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
            {
                return foundErrors;
            }
    ...
    public PackedIntArrayIF build(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        for (currentPosition = 0; currentPosition < numTags; currentPosition++)
        {
            ...
            switch (tag)
            {
                case FixGapFillFlagField.TagID:
                {
                    ...
                    fieldGapFillFlag = FixGapFillFlagField.create(array, offset, length);
                    if (fieldGapFillFlag == null || !fieldGapFillFlag.hasValue())
                    {
                ...
                case FixNewSeqNoField.TagID:
                {
                    ...
                    fieldNewSeqNo = FixNewSeqNoField.create(array, offset, length);
                    if (fieldNewSeqNo == null || !fieldNewSeqNo.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
