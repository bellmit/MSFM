...
/**
 * This GENERATED file implements FIX Protocol's Field Tag [28] (known as IOITransType).
 *
...
public abstract class FixIOITransTypeField implements FixFieldIF, HasCharValueIF
{   
    public static final int    TagID         =  28;
    public static final String TagIDAsString = "28";
    public static final char[] TagIDAsChars  = {'2','8'};
    public static final String TagName       = "IOITransType";
    ...
    public static final char[]  taggedchars_New      = {'2','8', EQUALSchar, 'N', SOHchar};
    ...
    public static final char[]  taggedchars_Cancel   = {'2','8', EQUALSchar, 'C', SOHchar};
    ...
    public static final char[]  taggedchars_Replace  = {'2','8', EQUALSchar, 'R', SOHchar};
    public static final String  text_Replace         = "Replace";

    private static FixIOITransTypeField flyweightNew;
    public static final FixIOITransTypeField flyweightNew()
    {
        if (flyweightNew == null)
        {
            synchronized(FixIOITransTypeField.class)
            {
                if (flyweightNew == null)
                {
                    flyweightNew  = new FixIOITransTypeField()
    ...
    private static FixIOITransTypeField flyweightCancel;
    public static final FixIOITransTypeField flyweightCancel()
    {
        if (flyweightCancel == null)
        {
            synchronized(FixIOITransTypeField.class)
            {
                if (flyweightCancel == null)
                {
                    flyweightCancel  = new FixIOITransTypeField()
                    {public boolean hasValue()                        {return true;}
    ...
    private static FixIOITransTypeField flyweightReplace;
    public static final FixIOITransTypeField flyweightReplace()
    {
        if (flyweightReplace == null)
        {
            synchronized(FixIOITransTypeField.class)
            {
                if (flyweightReplace == null)
                {
                    flyweightReplace  = new FixIOITransTypeField()
                    {public boolean hasValue()                        {return true;}
    ...
    public static FixIOITransTypeField create(char[] array, int offset, int length)
    {
        if (length == 1)
        {
    ...
    public static FixIOITransTypeField create(final char param)
    {
        switch (param)
        {                                                                                           
