...
/**
 * This GENERATED file implements FIX Protocol's DontKnowTrade Message.
 *
...
public class FixDontKnowTradeMessage extends FixMessage
{   
    public static final String MsgType        = "Q";
    public static final char   MsgTypeAsChar  = 'Q';
    public static final char[] MsgTypeAsChars = {'Q'};
    public static final String MsgTypeName    = "DontKnowTrade";

    public FixOrderIDField                   fieldOrderID;
    public FixExecIDField                    fieldExecID;
    public FixDKReasonField                  fieldDKReason;
    ...
    public FixDontKnowTradeMessage()
    {

    }

    public boolean isFixDontKnowTradeMessage() {return true;}
    ...
    public void accept(PrettyPrintWriterIF prettyPrintWriter)
    {
        ...
        prettyPrintWriter.printGroupItem(fieldDKReason);
    ...
    public void accept(FixMessageBuilderIF fixMessageBuilder)
    {
        ...
        fixMessageBuilder.append(fieldDKReason);
    ...
    public PackedIntArrayIF validate(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        if (fieldDKReason == null)
        {
            foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixDKReasonField.TagID));
            if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
            {
                return foundErrors;
            }
        ...
        for (currentPosition = 0; currentPosition < numTags; currentPosition++)
        {
            ...
            switch (tag)
            {
                ...
                case FixDKReasonField.TagID:
                {
                    ...
                    fieldDKReason = FixDKReasonField.create(array, offset, length);
                    if (fieldDKReason == null || !fieldDKReason.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
