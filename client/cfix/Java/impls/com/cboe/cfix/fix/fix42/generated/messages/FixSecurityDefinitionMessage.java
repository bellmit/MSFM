...
/**
 * FixSecurityDefinitionMessage.java
 *
...
/**
 * This GENERATED file implements FIX Protocol's SecurityDefinition Message.
 *
...
public class FixSecurityDefinitionMessage extends FixMessage
{   
    public static final String MsgType        = "d";
    public static final char   MsgTypeAsChar  = 'd';
    public static final char[] MsgTypeAsChars = {'d'};
    public static final String MsgTypeName    = "SecurityDefinition";

    public FixSecurityReqIDField             fieldSecurityReqID;
    public FixSecurityResponseIDField        fieldSecurityResponseID;
    public FixSecurityResponseTypeField      fieldSecurityResponseType;
    public FixTotalNumSecuritiesField        fieldTotalNumSecurities;
    ...
    public FixSecurityDefinitionMessage()
    {

    }

    public boolean isFixSecurityDefinitionMessage() {return true;}
    ...
    public void accept(PrettyPrintWriterIF prettyPrintWriter)
    {
        ...
        prettyPrintWriter.printGroupItem(fieldSecurityResponseID);
        prettyPrintWriter.printGroupItem(fieldSecurityResponseType);
        prettyPrintWriter.printGroupItem(fieldTotalNumSecurities);
    ...
    public void accept(FixMessageBuilderIF fixMessageBuilder)
    {
        ...
        fixMessageBuilder.append(fieldSecurityResponseID);
        fixMessageBuilder.append(fieldSecurityResponseType);
        fixMessageBuilder.append(fieldTotalNumSecurities);
    ...
    public PackedIntArrayIF validate(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        if (fieldSecurityResponseID == null)
        {
            foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixSecurityResponseIDField.TagID));
            if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
            {
                return foundErrors;
            }
        ...
        if (fieldTotalNumSecurities == null)
        {
            foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixTotalNumSecuritiesField.TagID));
            if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
            {
                return foundErrors;
            }
    ...
    public PackedIntArrayIF build(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        for (currentPosition = 0; currentPosition < numTags; currentPosition++)
        {
            ...
            switch (tag)
            {
                ...
                case FixSecurityResponseIDField.TagID:
                {
                    if (currentState != STATE_Field)
                    {
                        currentState = STATE_Field;
                    ...
                    fieldSecurityResponseID = FixSecurityResponseIDField.create(array, offset, length);
                    if (fieldSecurityResponseID == null || !fieldSecurityResponseID.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixSecurityResponseTypeField.TagID:
                {
                    if (currentState != STATE_Field)
                    {
                        currentState = STATE_Field;
                    ...
                    if (fieldSecurityResponseType != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    fieldSecurityResponseType = FixSecurityResponseTypeField.create(array, offset, length);
                    if (fieldSecurityResponseType == null || !fieldSecurityResponseType.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixTotalNumSecuritiesField.TagID:
                {
                    if (currentState != STATE_Field)
                    {
                        currentState = STATE_Field;
                    ...
                    fieldTotalNumSecurities = FixTotalNumSecuritiesField.create(array, offset, length);
                    if (fieldTotalNumSecurities == null || !fieldTotalNumSecurities.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
