...
/**
 * This GENERATED file implements FIX Protocol's TestRequest Message.
 *
...
public class FixTestRequestMessage extends FixMessage
{   
    public static final String MsgType        = "1";
    public static final char   MsgTypeAsChar  = '1';
    public static final char[] MsgTypeAsChars = {'1'};
    public static final String MsgTypeName    = "TestRequest";

    public FixTestReqIDField    fieldTestReqID;
    public List                 additionalUserFields;

    public FixTestRequestMessage()
    {

    }

    public boolean isFixTestRequestMessage() {return true;}
    ...
    public void accept(PrettyPrintWriterIF prettyPrintWriter)
    {
        ...
        prettyPrintWriter.printGroupItem(fieldTestReqID);
    ...
    public void accept(FixMessageBuilderIF fixMessageBuilder)
    {
        ...
        fixMessageBuilder.append(fieldTestReqID);
    ...
    public PackedIntArrayIF validate(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        if (fieldTestReqID == null)
        {
            foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixTestReqIDField.TagID));
            if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
            {
                return foundErrors;
            }
        ...
        for (currentPosition = 0; currentPosition < numTags; currentPosition++)
        {
            ...
            switch (tag)
            {
                case FixTestReqIDField.TagID:
                {
                    ...
                    fieldTestReqID = FixTestReqIDField.create(array, offset, length);
                    if (fieldTestReqID == null || !fieldTestReqID.hasValue())
                    {
