...
public class FixSessionWriter implements Runnable, FixSessionWriterIF, CfixMarketDataMDReqIDHelper
{
    ...
    protected CfixMarketDataFullRefreshMapper   cfixMarketDataFullRefreshMapper = new CfixMarketDataFullRefreshMapper();
    ...
    public FixSessionWriter(FixSession fixSession)
    {
