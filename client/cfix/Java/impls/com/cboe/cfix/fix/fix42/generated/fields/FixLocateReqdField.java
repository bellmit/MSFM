...
/**
 * This GENERATED file implements FIX Protocol's Field Tag [114] (known as LocateReqd).
 *
...
public abstract class FixLocateReqdField implements FixFieldIF, HasBooleanValueIF
{   
    public static final int    TagID         =  114;
    public static final String TagIDAsString = "114";
    public static final char[] TagIDAsChars  = {'1','1','4'};
    public static final String TagName       = "LocateReqd";
    ...
    public static final char[]  taggedchars_Yes  = {'1','1','4', EQUALSchar, 'Y', SOHchar};
    ...
    public static final char[]  taggedchars_No   = {'1','1','4', EQUALSchar, 'N', SOHchar};
    public static final String  text_No          = "No";

    private static FixLocateReqdField flyweightYes;
    public static final FixLocateReqdField flyweightYes()
    {
        if (flyweightYes == null)
        {
            synchronized(FixLocateReqdField.class)
            {
                if (flyweightYes == null)
                {
                    flyweightYes  = new FixLocateReqdField()
    ...
    private static FixLocateReqdField flyweightNo;
    public static final FixLocateReqdField flyweightNo()
    {
        if (flyweightNo == null)
        {
            synchronized(FixLocateReqdField.class)
            {
                if (flyweightNo == null)
                {
                    flyweightNo  = new FixLocateReqdField()
                    {public boolean hasValue()                        {return true;}
    ...
    public static FixLocateReqdField create(char[] array, int offset, int length)
    {
        if (length == 1)
        {                                                                                           
    ...
    public static FixLocateReqdField create(boolean param)
    {
