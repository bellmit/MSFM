...
/**
 * This GENERATED file implements FIX Protocol's News Message.
 *
...
public class FixNewsMessage extends FixMessage
{   
    public static final String MsgType        = "B";
    public static final char   MsgTypeAsChar  = 'B';
    public static final char[] MsgTypeAsChars = {'B'};
    public static final String MsgTypeName    = "News";

    public FixOrigTimeField              fieldOrigTime;
    public FixUrgencyField               fieldUrgency;
    public FixHeadlineField              fieldHeadline;
    //     FixEncodedHeadlineLenField    fieldEncodedHeadlineLen;// NOT GENERATED (marked as unused_by_cboe in the XML file)
    //     FixEncodedHeadlineField       fieldEncodedHeadline;// NOT GENERATED (marked as unused_by_cboe in the XML file)
    ...
    public FixNewsMessage()
    {

    }

    public boolean isFixNewsMessage() {return true;}
    ...
    public void accept(PrettyPrintWriterIF prettyPrintWriter)
    {
        ...
        prettyPrintWriter.printGroupItem(fieldUrgency);
        prettyPrintWriter.printGroupItem(fieldHeadline);
    ...
    public void accept(FixMessageBuilderIF fixMessageBuilder)
    {
        ...
        fixMessageBuilder.append(fieldUrgency);
        fixMessageBuilder.append(fieldHeadline);
    ...
    public PackedIntArrayIF validate(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        {
            foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixHeadlineField.TagID));
            if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
            {
                return foundErrors;
            }
        ...
        for (currentPosition = 0; currentPosition < numTags; currentPosition++)
        {
            ...
            switch (tag)
            {
                ...
                case FixUrgencyField.TagID:
                {
                    ...
                    fieldUrgency = FixUrgencyField.create(array, offset, length);
                    if (fieldUrgency == null || !fieldUrgency.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixHeadlineField.TagID:
                {
                    ...
                    fieldHeadline = FixHeadlineField.create(array, offset, length);
                    if (fieldHeadline == null || !fieldHeadline.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixEncodedHeadlineLenField.TagID:
                {
                    if (currentState != STATE_Field)
                    {
                        currentState = STATE_Field;
                    ...
                    {
                        FixEncodedHeadlineLenField unusedByCboeField = FixEncodedHeadlineLenField.create(array, offset, length);
                ...
                case FixEncodedHeadlineField.TagID:
                {
                    if (currentState != STATE_Field)
                    {
                        currentState = STATE_Field;
                    ...
                    if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.VALIDATE_UNUSED_FIELDS))
                    {
                        FixEncodedHeadlineField unusedByCboeField = FixEncodedHeadlineField.create(array, offset, length);
                        if (unusedByCboeField == null || !unusedByCboeField.hasValue())
                        {
                            unusedByCboeField = null;
