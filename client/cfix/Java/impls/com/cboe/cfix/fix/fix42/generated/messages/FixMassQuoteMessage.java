...
/**
 * This GENERATED file implements FIX Protocol's MassQuote Message.
 *
...
public class FixMassQuoteMessage extends FixMessage
{   
    public static final String MsgType        = "i";
    public static final char   MsgTypeAsChar  = 'i';
    public static final char[] MsgTypeAsChars = {'i'};
    public static final String MsgTypeName    = "MassQuote";
    ...
    public FixDefBidSizeField            fieldDefBidSize;
    public FixDefOfferSizeField          fieldDefOfferSize;
    ...
    {   
        ...
        public FixQuoteSetValidUntilTimeField fieldQuoteSetValidUntilTime;
        ...
        public void accept(PrettyPrintWriterIF prettyPrintWriter)
        {
            ...
            prettyPrintWriter.printGroupItem(fieldQuoteSetValidUntilTime);
        ...
        {                                                                                             
            ...
            fixMessageBuilder.append(fieldQuoteSetValidUntilTime);
    ...
    public FixMassQuoteMessage()
    {

    }

    public boolean isFixMassQuoteMessage() {return true;}
    ...
    public void accept(PrettyPrintWriterIF prettyPrintWriter)
    {
        ...
        prettyPrintWriter.printGroupItem(fieldDefBidSize);
        prettyPrintWriter.printGroupItem(fieldDefOfferSize);
    ...
    public void accept(FixMessageBuilderIF fixMessageBuilder)
    {
        ...
        fixMessageBuilder.append(fieldDefBidSize);
        fixMessageBuilder.append(fieldDefOfferSize);
    ...
    public PackedIntArrayIF validate(FixPacketIF fixPacket, PackedIntArrayIF foundErrors, int validationFlags, int debugFlags)
    {
        ...
        {
            foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixNoQuoteSetsField.TagID));
            if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
            {
                return foundErrors;
            }
        ...
        for (int i = 0; i < groupQuoteSets.length; i++)
        {
            if (groupQuoteSets[i].fieldQuoteSetID == null)
            {
                foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixQuoteSetIDField.TagID));
                if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
                {
                    return foundErrors;
                }
            ...
            if (groupQuoteSets[i].fieldUnderlyingSymbol == null)
            {
                foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixUnderlyingSymbolField.TagID));
                if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
                {
                    return foundErrors;
                }
            ...
            if (groupQuoteSets[i].fieldTotQuoteEntries == null)
            {
                foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixTotQuoteEntriesField.TagID));
                if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
                {
                    return foundErrors;
                }
            ...
            if (groupQuoteSets[i].groupQuoteEntries != null)
            {
                for (int j = 0; j < groupQuoteSets[i].groupQuoteEntries.length; j++)
                {
                    if (groupQuoteSets[i].groupQuoteEntries[j].fieldQuoteEntryID == null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.MISSING_REQUIRED_TAG, FixQuoteEntryIDField.TagID));
                        if (BitHelper.isBitMaskSet(validationFlags, FixMessageIF.STOP_ON_FIRST_ERROR))
                        {
                            return foundErrors;
                        }
        ...
        for (currentPosition = 0; currentPosition < numTags; currentPosition++)
        {
            ...
            switch (tag)
            {
                ...
                case FixDefBidSizeField.TagID:
                {
                    ...
                    fieldDefBidSize = FixDefBidSizeField.create(array, offset, length);
                    if (fieldDefBidSize == null || !fieldDefBidSize.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixDefOfferSizeField.TagID:
                {
                    if (currentState != STATE_Field)
                    {
                        currentState = STATE_Field;
                    ...
                    fieldDefOfferSize = FixDefOfferSizeField.create(array, offset, length);
                    if (fieldDefOfferSize == null || !fieldDefOfferSize.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixQuoteSetValidUntilTimeField.TagID:
                {
                    if (currentState != STATE_QuoteSetsGroup)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.TAG_IN_INVALID_POSITION, currentPosition));
                    ...
                    if (groupQuoteSets[current_groupQuoteSets].fieldQuoteSetValidUntilTime != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    groupQuoteSets[current_groupQuoteSets].fieldQuoteSetValidUntilTime = FixQuoteSetValidUntilTimeField.create(array, offset, length);
                    if (groupQuoteSets[current_groupQuoteSets].fieldQuoteSetValidUntilTime == null || !groupQuoteSets[current_groupQuoteSets].fieldQuoteSetValidUntilTime.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixBidPxField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldBidPx != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldBidPx = FixBidPxField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldBidPx == null || !curGroupQuoteEntries.fieldBidPx.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixOfferPxField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldOfferPx != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldOfferPx = FixOfferPxField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldOfferPx == null || !curGroupQuoteEntries.fieldOfferPx.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixBidSizeField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldBidSize != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldBidSize = FixBidSizeField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldBidSize == null || !curGroupQuoteEntries.fieldBidSize.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixOfferSizeField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldOfferSize != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldOfferSize = FixOfferSizeField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldOfferSize == null || !curGroupQuoteEntries.fieldOfferSize.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixValidUntilTimeField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldValidUntilTime != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldValidUntilTime = FixValidUntilTimeField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldValidUntilTime == null || !curGroupQuoteEntries.fieldValidUntilTime.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixBidSpotRateField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldBidSpotRate != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldBidSpotRate = FixBidSpotRateField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldBidSpotRate == null || !curGroupQuoteEntries.fieldBidSpotRate.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixOfferSpotRateField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldOfferSpotRate != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldOfferSpotRate = FixOfferSpotRateField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldOfferSpotRate == null || !curGroupQuoteEntries.fieldOfferSpotRate.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixBidForwardPointsField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldBidForwardPoints != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldBidForwardPoints = FixBidForwardPointsField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldBidForwardPoints == null || !curGroupQuoteEntries.fieldBidForwardPoints.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixOfferForwardPointsField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldOfferForwardPoints != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldOfferForwardPoints = FixOfferForwardPointsField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldOfferForwardPoints == null || !curGroupQuoteEntries.fieldOfferForwardPoints.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixTransactTimeField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldTransactTime != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldTransactTime = FixTransactTimeField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldTransactTime == null || !curGroupQuoteEntries.fieldTransactTime.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixTradingSessionIDField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldTradingSessionID != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldTradingSessionID = FixTradingSessionIDField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldTradingSessionID == null || !curGroupQuoteEntries.fieldTradingSessionID.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixFutSettDateField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldFutSettDate != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldFutSettDate = FixFutSettDateField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldFutSettDate == null || !curGroupQuoteEntries.fieldFutSettDate.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixOrdTypeField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldOrdType != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldOrdType = FixOrdTypeField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldOrdType == null || !curGroupQuoteEntries.fieldOrdType.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixFutSettDate2Field.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldFutSettDate2 != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldFutSettDate2 = FixFutSettDate2Field.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldFutSettDate2 == null || !curGroupQuoteEntries.fieldFutSettDate2.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixOrderQty2Field.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldOrderQty2 != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldOrderQty2 = FixOrderQty2Field.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldOrderQty2 == null || !curGroupQuoteEntries.fieldOrderQty2.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
                ...
                case FixCurrencyField.TagID:
                {
                    ...
                    if (curGroupQuoteEntries.fieldCurrency != null)
                    {
                        foundErrors.add(BitHelper.packInt(FixException.DUPLICATE_TAG, currentPosition));
                    ...
                    curGroupQuoteEntries.fieldCurrency = FixCurrencyField.create(array, offset, length);
                    if (curGroupQuoteEntries.fieldCurrency == null || !curGroupQuoteEntries.fieldCurrency.hasValue())
                    {
                        foundErrors.add(BitHelper.packInt(FixException.INVALID_TAG_VALUE, currentPosition));
