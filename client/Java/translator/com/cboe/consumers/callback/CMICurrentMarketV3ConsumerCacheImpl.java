...
import com.cboe.consumers.callback.CurrentMarketV3ConsumerFactory;
import com.cboe.domain.util.SessionKeyContainer;
import com.cboe.interfaces.consumers.callback.CMICurrentMarketV3ConsumerCache;
 ...
 */
public class CMICurrentMarketV3ConsumerCacheImpl extends AbstractCallbackConsumerCache implements CMICurrentMarketV3ConsumerCache
{
    /**
     ...
     * @param eventChannel
     */
    public CMICurrentMarketV3ConsumerCacheImpl(EventChannelAdapter eventChannel)
    {
        super(eventChannel);
    }
    ...
    {
        return (com.cboe.idl.cmiCallbackV3.CMICurrentMarketConsumer)getCallbackConsumer(key);
    }
    ...
    {
        return CurrentMarketV3ConsumerFactory.create(getEventChannel());
    }    
}
