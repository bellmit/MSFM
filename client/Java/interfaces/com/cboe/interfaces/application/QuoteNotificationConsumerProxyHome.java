...
/**
 * This is the common interface for the QuoteNotificationConsumerProxyHome
 * @author William Wei
 */
public interface QuoteNotificationConsumerProxyHome extends BaseProxyHome
{
   ...
   */
  public ChannelListener create(CMILockedQuoteStatusConsumer consumer, BaseSessionManager sessionManager);
}
