//
// -----------------------------------------------------------------------------------
// Source file: RecapProductCache.java
//
...
/**
 * Defines the API for the RecapProductCache.
 * 
 * @author Eric Maheo
 *
 * @param <T> is the class dispatch by the consumer.
 */
public interface RecapProductCache<T> extends ProductCache<T>, EventChannelListener
{
