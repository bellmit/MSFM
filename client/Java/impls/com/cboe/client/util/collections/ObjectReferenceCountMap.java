...
/**
 * ObjectReferenceCountMap.java
 *
 * @author Dmitry Volpyansky
 *
 * FILE GENERATED BY VELOCITY TEMPLATE ENGINE FROM /vobs/dte/client/generator/DV_XReferenceCountMap.java (KEY_TYPE=Object)
 *
 */

import com.cboe.client.util.*;

public class ObjectReferenceCountMap implements HasSizeIF
{
    ...
    public static final ObjectReferenceCountMap unsynchronizedMap()             {return new ObjectReferenceCountMap();}
    public static final ObjectReferenceCountMap unsynchronizedMap(int capacity) {return new ObjectReferenceCountMap(capacity);}
    public static final ObjectReferenceCountMap synchronizedMap()               {return new ObjectReferenceCountMapMT();}
    public static final ObjectReferenceCountMap synchronizedMap(int capacity)   {return new ObjectReferenceCountMapMT(capacity);}

    public static class ObjectReferenceCountMapMT extends ObjectReferenceCountMap
    {
        public ObjectReferenceCountMapMT()
        {
            super();
        }
        public ObjectReferenceCountMapMT(int capacity)
        {
            super(capacity);
        }
        public ObjectReferenceCountMapMT(ObjectReferenceCountMap map)
        {
            super(map);
        }
        ...
        public synchronized void incKeyValue(Object key, int value)
        {
            super.incKeyValue(key, value);
        }
        public synchronized void decKeyValuePositive(Object key, int value)
        {
        ...
        public synchronized void putKeyValue(Object key, int value)
        {
        ...
        public synchronized ObjectReferenceCountMap clear()
        {
            return super.clear();
        }
        public synchronized ObjectReferenceCountMap clear(ObjectIntArrayHolderIF arrayHolder)
        {
            return super.clear(arrayHolder);
        }
    };

    public ObjectReferenceCountMap()
    {
        this(DEFAULT_INITIAL_CAPACITY);
    }

    public ObjectReferenceCountMap(int capacity)
    {
        if (capacity < 2)
        {
    ...
    public ObjectReferenceCountMap(ObjectReferenceCountMap map)
    {
        synchronized(map)
        {
    ...
    public void incKeyValue(Object key)
    {
        incKeyValue(key, 1);
    }

    public void incKeyValue(Object key, int value)
    {
        int bucketIndex = (int) (key.hashCode() & tableHighestIndex);
    ...
    public void decKeyValue(Object key)
    {
        incKeyValue(key, -1);
    }

    public void decKeyValue(Object key, int value)
    {
        incKeyValue(key, -value);
    }

    public void decKeyValuePositive(Object key)
    {
        decKeyValuePositive(key, 1);
    }

    public void decKeyValuePositive(Object key, int value)
    {
        int bucketIndex = (int) (key.hashCode() & tableHighestIndex);
    ...
    public void putKeyValue(Object key, int value)
    {
        int bucketIndex = (int) (key.hashCode() & tableHighestIndex);
    ...
    public ObjectReferenceCountMap clear()
    {
    ...
    public ObjectReferenceCountMap clear(ObjectIntArrayHolderIF arrayHolder)
    {
        getData(arrayHolder);
