...
/**
 * IntObjectMultipleValuesMap.java
 *
 * @author Dmitry Volpyansky
 *
 * FILE GENERATED BY VELOCITY TEMPLATE ENGINE FROM /vobs/dte/client/generator/DV_XYMultipleValuesMap.java (KEY_TYPE=int, VALUE_TYPE=Object, THIRD_TYPE=)
 *
 */

import com.cboe.client.util.*;

public class IntObjectMultipleValuesMap implements HasSizeIF
{
    protected int[][]   keys;
    ...
    public static final IntObjectMultipleValuesMap unsynchronizedMap()             {return new IntObjectMultipleValuesMap();}
    public static final IntObjectMultipleValuesMap unsynchronizedMap(int capacity) {return new IntObjectMultipleValuesMap(capacity);}
    public static final IntObjectMultipleValuesMap synchronizedMap()               {return new IntObjectMultipleValuesMapMT();}
    public static final IntObjectMultipleValuesMap synchronizedMap(int capacity)   {return new IntObjectMultipleValuesMapMT(capacity);}

    public static class IntObjectMultipleValuesMapMT extends IntObjectMultipleValuesMap
    {
        public IntObjectMultipleValuesMapMT()
        {
            super();
        }
        public IntObjectMultipleValuesMapMT(int capacity)
        {
            super(capacity);
        }
        public synchronized int putKeyValue(int key, Object value)
        {
            return super.putKeyValue(key, value);
        }
        public synchronized int putKeyValue(int key, Object value, IntObjectKeyValuePolicyIF policy)
        {
        ...
        public synchronized Object getValueForKeyAt(int key, int multiIndex)
        {
            return super.getValueForKeyAt(key, multiIndex);
        }
        public synchronized void getValuesForKey(int key, ObjectArrayHolderIF arrayHolder)
        {
            super.getValuesForKey(key, arrayHolder);
        }
        public synchronized void getKeysForValue(Object value, IntArrayHolderIF arrayHolder)
        {
            super.getKeysForValue(value, arrayHolder);
        }
        public synchronized void getData(IntObjectArrayHolderIF arrayHolder)
        {
            super.getData(arrayHolder);
        }
        public synchronized int removeKeyValue(int key, Object value)
        {
            return super.removeKeyValue(key, value);
        }
        public int removeKeyValue(int key, Object value, MutableInteger mutableInteger)
        {
        ...
        public synchronized void removeKey(int key, ObjectArrayHolderIF arrayHolder)
        {
        ...
        public synchronized void removeValue(Object value, IntArrayHolderIF arrayHolder)
        {
        ...
        public synchronized IntObjectMultipleValuesMap clear()
        {
            return super.clear();
        }
        public synchronized IntObjectMultipleValuesMap clear(IntObjectArrayHolderIF arrayHolder)
        {
            return super.clear(arrayHolder);
        }
    };

    public IntObjectMultipleValuesMap()
    {
        this(DEFAULT_INITIAL_CAPACITY);
    }

    public IntObjectMultipleValuesMap(int capacity)
    {
        if (capacity < 2)
        {
    ...
    public IntObjectMultipleValuesMap setValueNotFound(Object ValueNotFound)
    {
    ...
    public int putKeyValue(int key, Object value)
    {
        ...
        if (keys[bucketIndex] == null)
        {
            ...
            values[bucketIndex][0]  = new Object[] {value};
        ...
        if (keyIndex >= 0)
        {
            ...
            {
                if (value == local_multivalues[multiIndex] || value.equals(local_multivalues[multiIndex]))
                {
        ...
        values[bucketIndex][keyIndex] = new Object[] {value};
    ...
    public int putKeyValue(int key, Object value, IntObjectKeyValuePolicyIF policy)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
    ...
    public int putKeyValue(int key, Object value, MutableInteger mutableInteger)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
    ...
    public int putKeyValue(int key, Object value, IntObjectKeyValuePolicyIF policy, MutableInteger mutableInteger)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
    ...
    public Object getValueForKeyAt(int key, int multiIndex)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
        ...
        if (numberKeys[bucketIndex] > 0)
        {
            ...
            if (keyIndex >= 0)
            {
                Object[] local_multimap = values[bucketIndex][keyIndex];
    ...
    public void getValuesForKey(int key, ObjectArrayHolderIF arrayHolder)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
    ...
    public void getKeysForValue(Object value, IntArrayHolderIF arrayHolder)
    {
        int        bucketSize;
        int        keyIndex;
        int        multiIndex;
    ...
    public void getData(IntObjectArrayHolderIF arrayHolder)
    {
        int               bucketSize;
        int               keyIndex;
        int               multiIndex;
...
//TODO:  ADD POLICIES TO REMOVE
    ...
    public int removeKeyValue(int key, Object value)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
    ...
    public void removeKey(int key, ObjectArrayHolderIF arrayHolder)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
    ...
    public void removeValue(Object value, IntArrayHolderIF arrayHolder)
    {
        int        bucketSize;
        int        keyIndex;
        int        multiIndex;
    ...
    public IntObjectMultipleValuesMap clear()
    {
        for (int bucketIndex = keys.length; --bucketIndex >= 0; )
        {
    ...
    public IntObjectMultipleValuesMap clear(IntObjectArrayHolderIF arrayHolder)
    {
        getData(arrayHolder);
