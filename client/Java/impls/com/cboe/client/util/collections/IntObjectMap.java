 ...
 *
 * FILE GENERATED BY VELOCITY TEMPLATE ENGINE FROM /vobs/dte/client/generator/DV_XYMap.java (KEY_TYPE=int, VALUE_TYPE=Object)
 *
 */

import com.cboe.client.util.*;

public class IntObjectMap implements HasSizeIF
{
    protected int[][] keys;
    ...
    public static final IntObjectMap unsynchronizedMap()             {return new IntObjectMap();}
    public static final IntObjectMap unsynchronizedMap(int capacity) {return new IntObjectMap(capacity);}
    public static final IntObjectMap synchronizedMap()               {return new IntObjectMapMT();}
    public static final IntObjectMap synchronizedMap(int capacity)   {return new IntObjectMapMT(capacity);}

    public static class IntObjectMapMT extends IntObjectMap
    {
        public IntObjectMapMT()
        {
            super();
        }
        public IntObjectMapMT(int capacity)
        {
            super(capacity);
        }
        ...
        public synchronized Object getValueForKey(int key)
        {
        ...
        public synchronized Object removeKey(int key)
        {
            return super.removeKey(key);
        }
        public synchronized Object removeKey(int key, IntObjectKeyValuePolicyIF policy)
        {
        ...
        public synchronized IntObjectMap clear()
        {
            return super.clear();
        }
        public synchronized IntObjectMap clear(IntObjectArrayHolderIF arrayHolder)
        {
    ...
    public Object getValueForKey(int key)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
    ...
    public Object removeKey(int key, IntObjectKeyValuePolicyIF policy)
    {
        int bucketIndex = (int) (key & tableHighestIndex);
    ...
    public IntObjectMap clear(IntObjectArrayHolderIF arrayHolder)
    {
        getData(arrayHolder);
