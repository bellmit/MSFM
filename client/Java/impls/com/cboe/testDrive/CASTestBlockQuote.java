...
public class CASTestBlockQuote extends CASTestQuote
{
    ...
    public CASTestBlockQuote(TestParameter parm, SessionManagerStructV2 sessionManagerStruct, CASMeter casMeter, int tid)
        throws Exception
    {
    ...
    public CASTestBlockQuote(TestParameter parm, UserSessionManagerV3 sessionManagerV3, CASMeter casMeter, int tid)
        throws Exception
    {
    ...
    public CASTestBlockQuote(TestParameter parm, SessionManagerStructV2 sessionManagerStruct, CASMeter casMeter, int tid, int loginNumber)
        throws Exception
    {
        super(parm, sessionManagerStruct, casMeter);
