...
public class ExpectedOpeningPriceSubscriptionImpl extends SessionClassSubscriptionImpl
{
    ...
    public ExpectedOpeningPriceSubscriptionImpl( SessionKeyWrapper sessionClass, SubscriptionAbstractCollection subscriptionCollection)
    {
    ...
    {
        ChannelKey channelKey = new ChannelKey(ChannelType.OPENING_PRICE_BY_CLASS, Integer.valueOf(sessionClass.getKey()));
        currentMarketConsumerHome.addFilter(channelKey);
        channelKey = new ChannelKey(ChannelType.OPENING_PRICE_BY_CLASS_SEQ, Integer.valueOf(sessionClass.getKey()));
        currentMarketConsumerHome.addFilter(channelKey);
