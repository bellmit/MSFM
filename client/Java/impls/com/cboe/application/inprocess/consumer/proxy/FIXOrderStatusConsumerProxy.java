...
public class FIXOrderStatusConsumerProxy extends OrderStatusCollectorProxy {
    ...
    public FIXOrderStatusConsumerProxy(OrderStatusConsumer orderStatusConsumer,
 ...
 /*   public ListenerProxyQueueControl getProxyWrapper() {
    ...
    private void processNewOrder(ChannelEvent event, BaseSessionManager baseSessionManager) throws DataValidationException, SystemException, NotFoundException, AuthorizationException, CommunicationException {
        ...
        if (!disableNewAck())
        {
	        ...
	        boolean ack = ackOrder(orderStruct);
    ...
    protected boolean ackOrder(OrderStruct order) {
        boolean ack = true;
