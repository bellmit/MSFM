...
import com.cboe.application.supplier.proxy.flushProxy.BookDepthV2ConsumerFlushProxy;
import com.cboe.application.supplier.proxy.overlayProxy.BookDepthV2ConsumerOverlayProxy;
...
import com.cboe.interfaces.application.BookDepthV2ConsumerProxyHome;
 ...
 * @author William Wei
 */
public class BookDepthV2ConsumerProxyHomeImpl extends BaseConsumerProxyHomeImpl implements BookDepthV2ConsumerProxyHome
{
    /** constructor. **/
    public BookDepthV2ConsumerProxyHomeImpl()
    {
        super();
    }
    ...
    {
        BookDepthV2ConsumerProxy bo = null;

        switch(queuePolicy)
        {
            case QueueActions.OVERLAY_LAST:
                BookDepthV2ConsumerOverlayProxy overlaybo = new BookDepthV2ConsumerOverlayProxy(consumer, sessionManager);
            ...
            case QueueActions.FLUSH_QUEUE:
                bo = new BookDepthV2ConsumerFlushProxy(consumer, sessionManager);
                break;
            case QueueActions.NO_ACTION:
            case QueueActions.DISCONNECT_CONSUMER:
                bo = new BookDepthV2ConsumerProxy(consumer, sessionManager, queuePolicy);
                break;
            default:
