 ...
 * @author Java Grinder
 */
public class CurrentMarketV3ConsumerInterceptor extends CallbackInterceptor implements CurrentMarketV3Consumer
{
     ...
     */
    public CurrentMarketV3ConsumerInterceptor(CMICurrentMarketConsumer o)
    {
        this.cmiObject = o;
    }
    ...
    /**
     */
    public void acceptCurrentMarket(com.cboe.idl.cmiMarketData.CurrentMarketStruct[] param0, com.cboe.idl.cmiMarketData.CurrentMarketStruct[] param1, int param2, short param3)
    {
        ...
        try
        {
            cmiObject.acceptCurrentMarket(param0, param1, param2, param3);
        }
