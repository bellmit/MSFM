...
import com.cboe.application.supplier.proxy.flushProxy.CurrentMarketV3ConsumerFlushProxy;
import com.cboe.application.supplier.proxy.overlayProxy.CurrentMarketV3ConsumerOverlayProxy;
...
import com.cboe.interfaces.application.CurrentMarketV3ConsumerProxyHome;
 ...
 * @author Jimmy Wang
 */
public class CurrentMarketV3ConsumerProxyHomeImpl extends BaseConsumerProxyHomeImpl implements CurrentMarketV3ConsumerProxyHome
{
    /** constructor. **/
    public CurrentMarketV3ConsumerProxyHomeImpl()
    {
        super();
    }
    ...
    {
        CurrentMarketV3ConsumerProxy bo = null;

        switch(queuePolicy)
        {
            case QueueActions.OVERLAY_LAST:
                CurrentMarketV3ConsumerOverlayProxy overlaybo = new CurrentMarketV3ConsumerOverlayProxy(consumer, sessionManager);
            ...
            case QueueActions.FLUSH_QUEUE:
                bo = new CurrentMarketV3ConsumerFlushProxy(consumer, sessionManager);
                break;
            case QueueActions.NO_ACTION:
            case QueueActions.DISCONNECT_CONSUMER:
                bo = new CurrentMarketV3ConsumerProxy(consumer, sessionManager, queuePolicy);
                break;
            default:
