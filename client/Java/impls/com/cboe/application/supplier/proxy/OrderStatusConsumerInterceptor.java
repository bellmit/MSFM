 ...
 * @author Java Grinder
 */
public class OrderStatusConsumerInterceptor extends CallbackInterceptor implements OrderStatusConsumer
{
     ...
     */
    public OrderStatusConsumerInterceptor(CMIOrderStatusConsumer o)
    {
        this.cmiObject = o;
    }
    ...
    public void startInstrumentation(String prefix, boolean privateOnly)
    {
        try
        {
            StringBuilder name = new StringBuilder(prefix.length()+Instrumentor.NAME_DELIMITER.length()+31);
    ...
    public void acceptNewOrder(com.cboe.idl.cmiOrder.OrderDetailStruct param0)
    {
        ...
        try
        {
            cmiObject.acceptNewOrder(param0);
    ...
    public void acceptOrderBustReinstateReport(com.cboe.idl.cmiOrder.OrderBustReinstateReportStruct param0)
    {
        ...
        try
        {
            cmiObject.acceptOrderBustReinstateReport(param0);
        } catch (RuntimeException ex)
        {
            exception = true;
            throw ex;
    ...
    public void acceptOrderBustReport(com.cboe.idl.cmiOrder.OrderBustReportStruct param0)
    {
        ...
        try
        {
            cmiObject.acceptOrderBustReport(param0);
        } catch (RuntimeException ex)
        {
            exception = true;
            throw ex;
    ...
    public void acceptOrderCanceledReport(com.cboe.idl.cmiOrder.OrderCancelReportStruct param0)
    {
        ...
        try
        {
            cmiObject.acceptOrderCanceledReport(param0);
        } catch (RuntimeException ex)
        {
            exception = true;
            throw ex;
    ...
    public void acceptOrderFilledReport(com.cboe.idl.cmiOrder.OrderFilledReportStruct param0)
    {
        ...
        try
        {
            cmiObject.acceptOrderFilledReport(param0);
        } catch (RuntimeException ex)
        {
            exception = true;
            throw ex;
    ...
    public void acceptOrderStatus(com.cboe.idl.cmiOrder.OrderDetailStruct[] param0)
    {
        ...
        try
        {
            cmiObject.acceptOrderStatus(param0);
        } catch (RuntimeException ex)
        {
            exception = true;
            throw ex;
