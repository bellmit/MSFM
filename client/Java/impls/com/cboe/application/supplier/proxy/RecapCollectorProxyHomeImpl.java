...
/**
 * RecapCollectorProxyHomeImpl.
 * @author Keith A. Korecky
 */
public class RecapCollectorProxyHomeImpl extends BaseConsumerProxyHomeImpl implements RecapCollectorProxyHome
{
    /** constructor. **/
    public RecapCollectorProxyHomeImpl()
    {
        super();
    }
    ...
    {
        RecapCollectorProxy bo = new RecapCollectorProxy(consumer, sessionManager, consumer);
