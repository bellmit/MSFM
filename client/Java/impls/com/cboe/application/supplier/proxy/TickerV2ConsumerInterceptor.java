 ...
 * @author Java Grinder
 */
public class TickerV2ConsumerInterceptor extends CallbackInterceptor implements TickerV2Consumer
{
     ...
     */
    public TickerV2ConsumerInterceptor(CMITickerConsumer o)
    {
        this.cmiObject = o;
    }
    ...
    /**
     */
    public void acceptTicker(com.cboe.idl.cmiMarketData.TickerStruct[] param0, int param1, short param2)
    {
        ...
        try
        {
            cmiObject.acceptTicker(param0, param1, param2);
        }
