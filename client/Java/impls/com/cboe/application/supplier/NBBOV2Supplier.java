...
public class NBBOV2Supplier extends UserSessionMarketDataBaseSupplier
{
    public NBBOV2Supplier(BaseSessionManager sessionManager)
    {
    ...
    {
        return NBBOV2ConsumerProxy.class.getName();
    }
}
