...
public class AuctionEnabledTradingPropertyBeanInfo extends SimpleBeanInfo
{
        ...
        if(allowedDescriptors == null)
        {
            ...
            try
            {
                allowedDescriptors[0] = new PropertyDescriptor("auctionType",
                                                               AuctionEnabledTradingProperty.class);
                allowedDescriptors[1] = new PropertyDescriptor("enabled",
                                                               AuctionEnabledTradingProperty.class);
            }
