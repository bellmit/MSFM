//
// -----------------------------------------------------------------------------------
// Source file: SimpleDoubleOldTradingPropertyGroup.java
//
...
import com.cboe.domain.tradingProperty.common.SimpleDoubleTradingPropertyImpl;

/**
 * Represents an OldTradingPropertyGroup for a single simple double
 */
public class SimpleDoubleOldTradingPropertyGroup extends AbstractOldTradingPropertyGroup
{
     ...
     */
    public SimpleDoubleOldTradingPropertyGroup(String sessionName, int classKey)
    {
     ...
     */
    public static SimpleDoubleOldTradingPropertyGroup getGroup(String sessionName, int classKey,
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        SimpleDoubleOldTradingPropertyGroup castedGroup = (SimpleDoubleOldTradingPropertyGroup) myGroup;
