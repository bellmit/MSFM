//
// -----------------------------------------------------------------------------------
// Source file: SimpleBooleanOldTradingPropertyGroup.java
//
...
/**
 * Represents an OldTradingPropertyGroup for a single simple boolean
 */
public class SimpleBooleanOldTradingPropertyGroup extends AbstractOldTradingPropertyGroup
{
     ...
     */
    public SimpleBooleanOldTradingPropertyGroup(String sessionName, int classKey)
    {
     ...
     */
    public static SimpleBooleanOldTradingPropertyGroup getGroup(String sessionName, int classKey,
                   ...
                   InvocationTargetException, AuthorizationException, TransactionFailedException
    {
        ...
        SimpleBooleanOldTradingPropertyGroup castedGroup = (SimpleBooleanOldTradingPropertyGroup) myGroup;
