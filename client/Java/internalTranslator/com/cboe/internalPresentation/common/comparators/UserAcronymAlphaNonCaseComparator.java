//
// -----------------------------------------------------------------------------------
// Source file: UserAcronymAlphaNonCaseComparator.java
//
 ...
 * The compare is done on acronym, then exchange, then by user id, all case insensitive.
 */
public class UserAcronymAlphaNonCaseComparator extends UserAccountIDAlphaNonCaseComparator
{
