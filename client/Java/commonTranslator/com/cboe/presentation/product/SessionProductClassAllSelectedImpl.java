//
// -----------------------------------------------------------------------------------
// Source file: SessionProductClassAllSelectedImpl.java
//
 ...
 */
class SessionProductClassAllSelectedImpl extends ProductClassAllSelectedImpl implements AllSessionProductClass
{
    private SessionKeyWrapper sessionKeyWrapper;
    private String sessionName;

    protected SessionProductClassAllSelectedImpl()
    {
        this(DefaultTradingSession.DEFAULT);
    }

    protected SessionProductClassAllSelectedImpl(String sessionName)
    {
        super();
    ...
    {
        return new SessionProductClassAllSelectedImpl(getTradingSessionName());
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if( isEqual )
        {
            if( obj instanceof SessionProductClassAllSelectedImpl )
            {
                isEqual = getTradingSessionName().equals(
                        (( SessionProductClassAllSelectedImpl ) obj).getTradingSessionName());
            }
            else
            {
                isEqual = false;
