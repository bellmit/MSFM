//
// -----------------------------------------------------------------------------------
// Source file: SessionProductDefaultImpl.java
//
...
/**
 * SessionProduct implementation for a Default SessionProduct for the OPTION type.
 */
class SessionProductDefaultImpl extends ProductDefaultImpl implements AllSessionProduct
{
    private SessionKeyWrapper sessionKeyWrapper;
    private String sessionName;

    protected SessionProductDefaultImpl()
    {
        this(DefaultTradingSession.DEFAULT);
    }

    protected SessionProductDefaultImpl(String sessionName)
    {
        super();
    ...
    {
        return new SessionProductDefaultImpl(getTradingSessionName());
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if( isEqual )
        {
            if( obj instanceof SessionProductDefaultImpl )
            {
                isEqual = getTradingSessionName().equals(
                        (( SessionProductDefaultImpl ) obj).getTradingSessionName());
            }
            else
            {
                isEqual = false;
