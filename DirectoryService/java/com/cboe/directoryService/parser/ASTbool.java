/* Generated By:JJTree: Do not edit this line. ASTbool.java */
...
public class ASTbool extends SimpleNode {
  ...
  public ASTbool(DirectoryServiceParser p, int id) {
    super(p, id);
    list = Collections.synchronizedList(new ArrayList());
  }
	...
	if (getNumOperator() == ((ASTbool)obj).getNumOperator()) {
	    for(int i = 0; i < getNumOperator(); i++) {
		if(((Integer)getOperator(i)).intValue() != ((Integer)((ASTbool)obj).getOperator(i)).intValue()) {
		    return false;
		}
	    }
	} else {
